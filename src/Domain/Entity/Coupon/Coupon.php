...
class Coupon
{
    ...
    public function toArray()
    {
        return [
            ...
            'validFrom'             => $this->getValidFrom() ? $this->getValidFrom()->getValue()->format('Y-m-d') . 'T00:00:00' : null,
            'validTo'               => $this->getValidTo() ? $this->getValidTo()->getValue()->format('Y-m-d') . 'T00:00:00' : null,
