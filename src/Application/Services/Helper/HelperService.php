...
class HelperService
{
     ...
     * @throws Exception
     */
    public function getCustomerCabinetUrl($email, $type, $dateStartString, $dateEndString, $locale)
    {
     ...
     * @return array
     */
    public function getBookingTranslation($bookingInfo, $entityTranslation, $type)
    {
        /** @var SettingsService $settingsService */
        $settingsService = $this->container->get('domain.settings.service');
        ...
        return
            ...
            $bookingInfo &&
            $entityTranslation &&
            !empty($bookingInfo['locale']) &&
            !empty($entityTranslation[$type][$bookingInfo['locale']]) &&
            in_array($bookingInfo['locale'], $usedLanguages) ?
